...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public TelaLogin() {
        initComponents();
        this.setLocationRelativeTo(null);//inicializar centralizado
    ...
    /*
    *   BOTAO ENTRAR
    *   Quando acionado é repassado o conteúdo dos campos usuário e senha para o métodoVerificaLogin
    *   No metodo verificaLogin da Classe login é feito a valdação do usuário no arquivo de texto.txt
    */
    private void bLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLoginActionPerformed
        ...
        try {
            if (login.verificaLogin(tLogin.getText(), senha)) {
                TelaInicial tl = new TelaInicial();
                dispose();
                tl.setLocationRelativeTo(null);//para centralizar
                tl.setVisible(true);
            } else{
